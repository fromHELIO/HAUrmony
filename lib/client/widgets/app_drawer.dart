...
class AppDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Future<List<String>> _getNameEmail() async {

      final email = user!.email ?? 'data not found';
      ...
      final fullName = '${userInfo["first_name"]} ${userInfo["last_name"]}';
          ...
          child: SafeArea(
            child: ValueListenableBuilder(
              ...
              builder: (context, dynamic profile, _) {
                ...
                final name = asyncSnapshot.data![0];
                final email = asyncSnapshot.data![1];
