...
/// Helper that returns the Haurmony PNG hamburger button.
/// Use in AppBar.actions:
///   import '../widgets/app_drawer.dart';
///   actions: [haurmonyHamburger(end: true)] // end=true opens endDrawer
      ...
      child: SafeArea(
        child: ValueListenableBuilder(
          ...
          builder: (context, dynamic profile, _) {
            ...
            final initials = (profile?.initials ?? 'U').toString();
            final colorValue = profile?.colorValue ?? 0xFFD32F2F;
            ...
            if (avatarPath != null && avatarPath.isNotEmpty) {
              ...
              if (f.existsSync()) {
                avatarWidget = CircleAvatar(radius: 36, backgroundImage: FileImage(f));
              } else {
                avatarWidget = CircleAvatar(radius: 36, backgroundColor: Color(colorValue), child: Text(initials, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)));
              }
            } else {
              avatarWidget = CircleAvatar(radius: 36, backgroundColor: Color(colorValue), child: Text(initials, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)));
            }
