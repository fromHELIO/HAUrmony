...
class _ZoneSelectionScreenState extends State<ZoneSelectionScreen> {
  // Simulate taken tickets (replace with real data)
  final int zoneATaken = 57;
  final int zoneBTaken = 123;
  final int zoneCTaken = 289;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBarWithHamburger(context, showBack: true, openEndDrawer: true),
      body: Padding(
          ...
          children: [
            Card(
              ...
              child: SizedBox(
                ...
                child: Row(
                  children: [
                    _zoneTopCard('ZONE A', 'Closest to stage', zoneATaken), // added taken count
                    _verticalDivider(),
                    _zoneTopCard('ZONE B', 'Mid-range view', zoneBTaken), // added taken count
                    _verticalDivider(),
                    _zoneTopCard('ZONE C', 'Farthest, budget', zoneCTaken), // added taken count
                  ],
                ),
              ),
            ),
  ...
  Widget _zoneTopCard(String label, String description, int taken) {
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              RotatedBox(quarterTurns: 3, child: Text(label, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 40, letterSpacing: 4, color: isSelected ? kLogoColor : Colors.black))),
              RotatedBox(quarterTurns: 3, child: Text(description, style: TextStyle(fontSize: 12, color: Colors.black54))),
              RotatedBox(quarterTurns: 3, child: Text('$taken taken', style: TextStyle(fontSize: 12, color: Colors.black54))), // added taken count
            ],
          ),
        ),
      ),
